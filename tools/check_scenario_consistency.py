...
def check_scenario_consistency(scenario_path):
    ...
    rgb_video_path = os.path.join("my_sim2real_videos/rgb", f"{scenario_name}.mp4")
    disparity_video_path = os.path.join("my_sim2real_videos/disparity", f"{scenario_name}.mp4")
    video_counts = {}
...
def main():
    ...
    rgb_video_dir = "my_sim2real_videos/rgb"
    disparity_video_dir = "my_sim2real_videos/disparity"
